...
<div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed">
    @include('layouts.customer.include.sidebar')
    @include('layouts.customer.include.header')
    @yield('mainContainer')
    @include('layouts.customer.include.footer')
    @include('layouts.customer.include.modals')
</div>
