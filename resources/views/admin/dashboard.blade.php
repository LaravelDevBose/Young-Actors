                    ...
                    <div class="col-xl-6 col-12">
                        ...
                        <div class="box bg-warning">
                            <div class="box-body">
                                ...
                                <button type="button" class="waves-effect waves-light btn btn-outline btn-rounded btn-dark float-right">SAVE</button>
                            </div>
                        </div>
                        <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="p-15">
                                            ...
                                            <div class="mt-30">
                                                <h4>Status: Live</h4>
                                                <p class="mb-0 font-weight-700"><i class="ti-location-pin text-danger font-size-16"></i> <span class="font-size-12">12 Osborne Drive Suite 845</span></p>
                                                <div class="mt-40">
